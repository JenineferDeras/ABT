...
class FinancialAnalyzer:
    ...
    def profitability_analysis(df: pd.DataFrame) -> Dict:
        ...
        profit_metrics = {
            ...
            'profit_by_account_type': df.groupby('account_type')['profit_potential'].sum().to_dict(),
            'profit_by_risk_category': df.groupby('risk_category')['profit_potential'].sum().to_dict()
        }
