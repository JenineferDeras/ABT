  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-purple-500/10 bg-slate-900/40 p-6">
      ...
      <ol className="list-decimal space-y-2 pl-5 text-sm text-purple-100/90">
        ...
        <li>
          Create an <code>.env.local</code> file in the repository root with the
          following entries and restart the dev server:
        ...
        <li>
          Run <code>npm run dev</code> and confirm the authentication flow works
          end-to-end.
        </li>
      </ol>
      <p className="text-xs text-purple-200/70">
        Need a checklist? Review <strong>SUPABASE_SETUP.md</strong> for regional
